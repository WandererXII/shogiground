var Chessground = (function () {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.createEl = exports.isRightButton = exports.eventPosition = exports.setVisible = exports.translateRel = exports.translateAbs = exports.posToTranslateRel = exports.posToTranslateAbs = exports.samePiece = exports.distanceSq = exports.opposite = exports.timer = exports.memo = exports.key2pos = exports.pos2key = exports.allKeys = exports.invRanks = void 0;

	exports.invRanks = ['9', '8', '7', '6', '5', '4', '3', '2', '1'];
	exports.allKeys = Array.prototype.concat(...types.files.map(c => types.ranks.map(r => c + r)));
	exports.pos2key = (pos) => exports.allKeys[9 * pos[0] + pos[1]];
	...
	function premove(pieces, key, canCastle) {
	    ...
	    if (!piece)
	        return [];
	    const pos = util.key2pos(key), r = piece.role, mobility = r === 'pawn' ? pawn(piece.color) : (r === 'knight' ? knight : (r === 'bishop' ? bishop : (r === 'rook' ? rook : (king(piece.color, rookFilesOf(pieces, piece.color), canCastle)))));
	...
	function configure(state, config) {
	    ...
	    if (!state.movable.rookCastle && state.movable.dests) {
	        const rank = state.movable.color === 'white' ? '1' : '9', kingStartPos = 'e' + rank, dests = state.movable.dests.get(kingStartPos), king = state.pieces.get(kingStartPos);
	...
	function renderCircle(brush, pos, current, bounds) {
	    const o = pos2px(pos, bounds), widths = circleWidth(bounds), radius = (bounds.width + bounds.height) / 36;
	...
	function renderPiece(baseUrl, pos, piece, bounds) {
	    const o = pos2px(pos, bounds), size = bounds.width / 9 * (piece.scale || 1), name = piece.color[0] + (piece.role === 'knight' ? 'n' : piece.role[0]).toUpperCase();
